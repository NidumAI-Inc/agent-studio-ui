  ...
  function onSubmit(payload: any) {
    ...
    if (!modelData) {
      ...
      createData = {
        ...
        TTS_provider: modelData?.TTS_provider || "server",
        ...
        LLM_provider: modelData?.LLM_provider || "server",
        LLM_model: modelData?.LLM_model || "server",
        stt_provider: modelData?.stt_provider || "server",
        stt_model: modelData?.stt_model || "server",
